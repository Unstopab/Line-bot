...
#存取圖片連結
# link_image_lst=[]
# for link_image in image_lst:
image = driver.find_element_by_xpath("/html/body/div[2]/section[5]/div/div[1]/div[4]/ul[1]/li[1]/img")
    # element.get_attribute("src")
    # link=driver.find_elements_by_link_text(link_image)
    # link_image_url=link[0].get_attribute("href")
    # link_image_lst.append(link_image_url)
print(image)
# print(soup)
# print(name)
# #存取結果基本資料
